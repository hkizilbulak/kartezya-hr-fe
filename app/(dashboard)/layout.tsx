...
const ROUTE_GUARDS: RouteGuard[] = [
  ...
  { prefix: '/cv-upload', capability: Capability.CanManageCV },
  { prefix: '/cv-search', capability: Capability.CanManageCV },
  { prefix: '/candidates', capability: Capability.CanManageCV },
